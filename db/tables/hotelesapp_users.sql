...
CREATE TABLE `users` (
  ...
  `rol` enum('admin','guest') DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'Zona 5','wesito2004@gmail.com','1234567890101','1234567-8','admin',1,'12345','William','Enrique','Salguero','Camey');
